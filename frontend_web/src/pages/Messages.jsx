  ...
  const handleStartConversation = async (otherUserId, sessionContext = null) => {
    try {
      ...
      if (result.success) {
        ...
        } else if (location.state?.action === 'startConversation' && !conversationMessages.length) {
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="text-sm text-gray-600 dark:text-gray-400">
            <span className="italic">Messages are stored locally only</span>
          </div>
        </div>
      </div>
            ...
            {loading && conversations.length === 0 ? (
              ...
              <ul>
                {conversations.map((conversation) => {
                  ...
                  const lastMessage = conversation.lastMessage || { text: "Start a conversation" };
